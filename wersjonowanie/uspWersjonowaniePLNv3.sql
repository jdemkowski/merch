...
SELECT
	...
	,fix.ATTACHED_TO
	--,fix.HORIZ_GAP
	-- HORIZ_GAP zawsze ma byæ równy 0 dla pó³ki,
	-- ¿eby konwersja Spacemana nie zjeba³a ustawienia na pó³kach!!!
	,0 AS HORIZ_GAP
	,fix.SPACER_THICK
	,fix.FINGER_SPACE
	--,fix.AVAILABLE
	-- AVAILABLE musimy przeliczyæ ponownie, bo na pó³kach
	-- sta³y produkty w wersji wejœciowej, sama formu³a
	...
	,fix.LABEL
	--,fix.SPREAD_PRODUCTS
	-- przywracamy ka¿dej pó³ce opcjê roz³o¿enia
	...
	,fix.FLIPPED
	--,fix.AUTO_CRUSH
	-- mo¿na ustawiæ AUTO_CRUSH pojedynczym pó³kom,
	-- lecz procedura wype³niaj¹ca pó³ki nie obs³uguje jeszcze
...
SELECT
	...
	-- poni¿ej trochê inny format daty dd.mm.yyy
...
/* ================================================================================================================ */
/*
	Odkomentowanie pozosta³ej czêœci powoduje równie¿ przeniesienie przypisanych produktów 
	oraz pozycji na pó³kach z wersji wejœciowej do wersji wyjœciowej.
*/
/*
